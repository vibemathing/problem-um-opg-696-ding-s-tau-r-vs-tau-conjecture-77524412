...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-696-ding-s-tau-r-vs-tau-conjecture-77524412-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-696"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-696-ding-s-tau-r-vs-tau-conjecture-77524412-v1",
      "problem_contract_sha256": "3d81ae55588e940f9457596897e3c04461e647f34321af6b1b3cf9fdeaf9f3c3",
      "problem_id": "problem:um-opg-696-ding-s-tau-r-vs-tau-conjecture-77524412",
      "route_id": "route:um-opg-696-ding-s-tau-r-vs-tau-conjecture-77524412-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-696-ding-s-tau-r-vs-tau-conjecture-77524412-source-fidelity-01",
      "graph_id": "graph:um-opg-696-ding-s-tau-r-vs-tau-conjecture-77524412-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-696-ding-s-tau-r-vs-tau-conjecture-77524412-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-696-ding-s-tau-r-vs-tau-conjecture-77524412-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture Let $r \\ge 2$ be an integer and let $H$ be a minor minimal clutter with $\\frac{1}{r}\\tau_r(H) < \\tau(H)$. Then either $H$ has a $J_k$ minor for some $k \\ge 2$ or $H$ has Lehman's property."
          },
          "statement_sha256": "0892ecff9bcc0d4db3090be609eb5afde872d51bfe0e4e953bc2febc27ef9be2"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-696-ding-s-tau-r-vs-tau-conjecture-77524412-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-696-ding-s-tau-r-vs-tau-conjecture-77524412-root",
      "route_id": "route:um-opg-696-ding-s-tau-r-vs-tau-conjecture-77524412-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-696-f2b21fdea19b",
        "url": "https://www.unsolvedmath.com/problems/OPG-696"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
